...
from models.schemas import ParameterSchema, ReportInfo, ReportMetadata
...
class ReportRepository:
    ...
    def _load_report(self, report_dir: Path) -> Report:
        ...
        for param in metadata_dict.get("parameters", []):
            parameters.append(ParameterSchema(**param))
    ...
    def list_reports(self) -> List[ReportMetadata]:
        ...
        return [report.metadata for report in self._reports.values()]
    ...
    def get_report_info(self, report_id: str) -> ReportInfo:
        ...
        return ReportInfo(
            ...
            query_files=[f.name for f in report.query_files],
        )
